...
import TourContentSecvice from '../TourDetailLayout/TourContentSecvice';

const TourContentDocument = () => {
  ...
  return (
    <Flex className="justify-between mt-16">
      <div className="w-[72px]">
        <Image src={documentIcon} alt="image" />
      </div>
...
export default TourContentDocument;
